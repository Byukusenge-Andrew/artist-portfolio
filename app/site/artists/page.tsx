    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center mb-16">
                <h1 className="text-4xl font-bold text-gray-900 mb-4">Our Featured Artists</h1>
            ...
            {artists.length === 0 ? (
                <div className="text-center py-20 bg-gray-50 rounded-2xl">
                    ...
                    <p className="text-gray-600 mb-6">Our community is growing! Check back soon for new artists.</p>
                    <Link
                ...
                <div className="space-y-16">
                    {artists.map((artist) => (
                        <div key={artist.id} className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
                            <div className="p-6 sm:p-8 flex flex-col md:flex-row gap-8 items-start">
                                ...
                                <div className="flex-shrink-0 flex flex-col items-center md:items-start text-center md:text-left md:w-64 space-y-4">
                                    ...
                                    <Link
                                        ...
                                        className="inline-flex items-center gap-2 text-sm font-semibold text-teal-700 hover:text-teal-800 transition-colors mt-auto"
                                    >
                                        View Full Profile

        ...
        <div className="min-h-screen bg-[#f5f5f0] dark:bg-[#0f0f12] transition-colors">
            ...
            <div className="bg-white dark:bg-[#1a1a24] border-b border-gray-200 dark:border-gray-800 transition-colors">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
                        {/* Avatar */}
                        <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-white dark:border-[#1a1a24] shadow-xl bg-gray-100 dark:bg-gray-800 flex-shrink-0 transition-colors">
                            {artist.avatarUrl ? (
                                <Image
                        ...
                        <div className="flex-1 text-center md:text-left">
                            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-gray-100 mb-4">{artist.name || "Artist"}</h1>

                            {artist.bio && (
                                <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl leading-relaxed mb-6">
                                    {artist.bio}
                                </p>
                            )}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                {artist.uploadedArtworks.length === 0 ? (
                    <div className="text-center py-20 bg-white dark:bg-[#1a1a24] rounded-2xl border border-dashed border-gray-200 dark:border-gray-700 transition-colors">
                        <p className="text-gray-500 dark:text-gray-400 text-lg">No artworks in portfolio yet.</p>
                    </div>
                ) : (

...
async function getCurrentUser() {
    ...
    if (user.role !== "ARTIST") redirect("/user/dashboard");

    return user;
}

export default async function ArtistCommissionPage(props: { params: Promise<{ id: string }> }) {
    ...
    if (!commission || commission.artistId !== user.userId) {
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white dark:bg-[#1a1a24] rounded-xl border border-gray-200 dark:border-gray-700 p-6 shadow-sm">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="font-medium text-gray-900 dark:text-gray-100">{commission.name}</p>
                                </div>

                                <div>
                                    <p className="text-sm text-gray-500 dark:text-gray-400 mb-1">Email</p>
                                    <a href={`mailto:${commission.email}`} className="font-medium text-teal-600 dark:text-teal-400 hover:underline">
                                        {commission.email}
                                    </a>
                                </div>

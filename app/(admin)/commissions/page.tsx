...
const statusConfig: Record<Commission["status"], { label: string; color: string }> = {
  ...
  IN_REVIEW: { label: "In Review", color: "bg-yellow-100 text-yellow-800 border-yellow-300" },
  INVOICE_SENT: { label: "Invoice Sent", color: "bg-purple-100 text-purple-800 border-purple-300" },
...
export default function CommissionsAdminPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="text-3xl font-bold mb-8">Commission Requests</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">{commission.email}</p>
          ...
          {selectedCommission && (
            <div className="bg-white rounded-lg border border-gray-200 p-6 sticky top-8 h-fit">
              <h2 className="text-xl font-bold mb-4">{selectedCommission.name}</h2>
              ...
              <div className="space-y-4 mb-6">
                <div>
                  ...
                  <p className="flex items-center gap-2 text-gray-900 mt-1">
                    ...
                    <a href={`mailto:${selectedCommission.email}`} className="text-teal-600 hover:underline">
              ...
              <div className="mb-6">
                <label className="text-xs font-semibold text-gray-500 uppercase">Commission Details</label>
                <p className="text-gray-700 mt-2 whitespace-pre-wrap">{selectedCommission.details}</p>
              </div>

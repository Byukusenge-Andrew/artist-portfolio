...
function RegisterForm() {
  ...
  if (success) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-50 dark:from-[#0f0f12] dark:to-[#141418] flex items-center justify-center px-4 sm:px-6">
        <div className="w-full max-w-md bg-white dark:bg-[#1a1a24] rounded-2xl border border-gray-200 dark:border-gray-700 shadow-xl p-8 sm:p-10 text-center">
    ...
    >
      ...
      <div className="mt-6 space-y-3">
        <p className="text-center text-gray-600 dark:text-gray-400 text-sm">
          ...
          <Link href="/auth/login" className="text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 font-semibold">
            Sign in
          </Link>
        </p>
        <p className="text-center text-gray-600 dark:text-gray-400 text-sm">
          Want to sell art?{" "}
          <Link href="/auth/artist-signup" className="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium">

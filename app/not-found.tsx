        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 animate-fade-in">
            <div className="mb-8 relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-2xl font-semibold text-gray-900 bg-white/80 backdrop-blur-sm px-4 py-2 rounded-lg border border-gray-200 shadow-sm">
                        Page Not Found
                    </span>
                </div>
            </div>
            ...
            <div className="w-full max-w-md mb-10">
                <p className="text-sm text-gray-500 mb-3 font-medium">Try searching for something else:</p>
                <SearchBox />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-gray-300 text-gray-700 bg-white rounded-lg hover:bg-gray-50 hover:border-gray-400 transition-all duration-300"
                >
            ...
            <div className="mt-16 pt-8 border-t border-gray-200 w-full max-w-2xl px-4 flex flex-col sm:flex-row justify-between text-sm text-gray-500">
                <span>Need help? <Link href="/contact" className="text-teal-600 hover:underline">Contact Support</Link></span>
